        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4">
                <fo:flow flow-name="xsl-region-body">
                    <!-- Header Section -->
                    <fo:block font-family="Arial" font-size="24pt" font-weight="bold" color="black" text-align="left" space-after="10pt">
                        INVOICE
                    </fo:block>

                    <fo:block font-family="Arial" font-size="10pt" text-align="left" space-after="5pt">
                        <fo:inline>Invoice Number: INV-01234</fo:inline>
                        <fo:inline text-align="right" space-before="8cm">Date: April 11, 2023</fo:inline>
                    </fo:block>

                    <fo:block font-family="Arial" font-size="10pt" text-align="left" space-after="20pt">
                        <fo:inline>123 Anywhere St., Any City</fo:inline>
                        <fo:inline text-align="right" space-before="8cm">+123-456-7890</fo:inline>
                    </fo:block>
                    ...
                    <!-- Itemized List Table -->
                    <fo:table table-layout="fixed" width="100%" space-after="20pt">
                        ...
                        <fo:table-header>
                            <fo:table-row background-color="black" color="white">
                                ...
                                <fo:table-cell padding="5pt">
                                    <fo:block font-family="Arial" font-size="10pt" font-weight="bold" text-align="left">DESCRIPTION</fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="5pt">
